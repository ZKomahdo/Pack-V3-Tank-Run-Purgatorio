new moreCommonsAmount;
new Handle:MoreCommonsLimit;
new Handle:MoreCommonsIncrement;
new wanderingCommonsAmount;
new Handle:WanderingCommonsLimit;
new Handle:WanderingCommonsIncrement;
new Handle:WanderingCommonsStart;
new Float:commonBodyArmour;
new Handle:CommonBodyArmourAmount;
new Handle:CommonBodyArmourMax;
new bool:bCommonMeleeImmune;
new Handle:ChargerJumpPerLevel;
new bool:bCommonFireImmune;
new witchCount;
new witchMax;
new Handle:WitchMaximumIncrement;
new Handle:WitchMaximumDefault;
new Handle:WitchMaximum;
new Handle:WitchCostByLevel;
new bool:TUpgrade_CarryJump;
new bool:SufferingFromBloatAmmo[MAXPLAYERS + 1];
new bool:ChargerCanJump[MAXPLAYERS + 1];
new bool:ChargerIsJumping[MAXPLAYERS + 1];
new ChargerCarryVictim[MAXPLAYERS + 1];
new Handle:ChargerJumpCooldownTime;
new Handle:ChargerCarryJumpForce;
new bool:ChargerJumpCooldown[MAXPLAYERS + 1];
new WOF[MAXPLAYERS + 1][7];
new Bounty[MAXPLAYERS + 1];
new Handle:ChargerSpeedPerLevel;
new Handle:ChargerBlindPerLevel;
new Handle:BoomerSlowPerLevel;
new Handle:StickyBileSpeed;
new Handle:StickyBileTime;
new Handle:StickyBilePerLevel;
new Handle:StickySpitPerLevel;
new Handle:SmokerWhipForceLevel;
new Handle:RideJumpForceLevel;
new Handle:BlindBilePerLevel;
