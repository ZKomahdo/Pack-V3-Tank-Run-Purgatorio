...
MySQL_Init()
{
	...
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `ilevels` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	...
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `presets` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	...
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `mounted_cat` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `chat_color` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `time` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `daily_achieve` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `achieve` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "CREATE TABLE IF NOT EXISTS `trails` (`steam_id` varchar(32) NOT NULL, PRIMARY KEY (`steam_id`)) TYPE=MyISAM;");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/*	Bullet Trails	*/

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `id` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `enable` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `pi0` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `pi1` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `pi2` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `pi3` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `uz0` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `uz1` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `uz2` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `uz3` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sh0` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sh1` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sh2` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sh3` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `ri0` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `ri1` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `ri2` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `ri3` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sn0` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sn1` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sn2` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `trails` ADD `sn3` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/*	Permanent Achievements	*/
	
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `achieve` ADD `id` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `achieve` ADD `cstm` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/* Daily Achievements */

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `daily_achieve` ADD `id` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `daily_achieve` ADD `ck` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `daily_achieve` ADD `sik` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `daily_achieve` ADD `sid` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `daily_achieve` ADD `hpd` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `daily_achieve` ADD `day` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/*	Player Time Played	*/

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `name` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `td` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `th` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `tm` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `ts` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `id` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `ih` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `im` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `is` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `sd` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `sh` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `sm` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `ss` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `infl` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `survl` int(4) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `time` ADD `bty` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/*	Player Chat Colors	*/
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `chat_color` ADD `paranthesis` varchar(8) NOT NULL DEFAULT 'def';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `chat_color` ADD `team` varchar(8) NOT NULL DEFAULT 'def';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `chat_color` ADD `name` varchar(8) NOT NULL DEFAULT 'def';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `chat_color` ADD `text` varchar(8) NOT NULL DEFAULT 'def';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	...
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `player_cat` ADD `cmds` int(32) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/*		SURVIVOR LEVEL STUFF		*/
	//NAME
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `id` varchar(32) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//PHYSICAL
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `phx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `phn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `phl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//PISTOL
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `pix` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `pin` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `pil` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//MELEE
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `mex` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `men` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `mel` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//UZI
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `uzx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `uzn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `uzl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//SHOTGUN
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `shx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `shn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `shl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//SNIPER
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `snx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `snn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `snl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//RIFLE
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `rix` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `rin` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `ril` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//GRENADE
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `grx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `grn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `grl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//ITEM
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `itx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `itn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `slevels` ADD `itl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);

	/*		INFECTED LEVEL STUFF		*/
	//NAME
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `id` varchar(32) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//INFECTED
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `inx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `inn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `inl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//HUNTER
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `hux` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `hun` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `hul` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `huw` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//SMOKER
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `smx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `smn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `sml` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `smw` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//BOOMER
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `box` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `bon` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `bol` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `bow` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//JOCKEY
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `jox` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `jon` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `jol` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `jow` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//CHARGER
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `chx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `chn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `chl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `chw` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//SPITTER
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `spx` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `spn` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `spl` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `spw` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	//TANK
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `tax` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `tan` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `tal` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `ilevels` ADD `taw` int(16) NOT NULL DEFAULT '1';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	...
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `id` varchar(32) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `mw1` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `mw2` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `mw3` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `mw4` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `mw5` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `sw1` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `sw2` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `sw3` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `sw4` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `sw5` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `hi1` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `hi2` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `hi3` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `hi4` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `hi5` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `gi1` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `gi2` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `gi3` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `gi4` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `gi5` varchar(32) NOT NULL DEFAULT 'none';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `unlocked4` int(32) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `presets` ADD `unlocked5` int(32) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
	...
	Format(TQuery, sizeof(TQuery), "ALTER TABLE `mounted_cat` ADD `purchased` int(16) NOT NULL DEFAULT '0';");
	SQL_TQuery(hDatabase, QueryCreateTable, TQuery);
}
